...
/*   Updated: 2025/04/17 23:37:16 by jegerman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	view_map_iter_to_color(double iter, t_fra *fra)
{
	...
	nor_i = iter / fra->max_iter;
	col.r = (255 / 2) * (1 + sin((nor_i * 2 PI) + (3 PI / 2)));
	col.g = (255 / 2) * (1 + sin((nor_i * 2 PI) + (11 PI / 6)));
	col.b = (255 / 2) * (1 + sin((nor_i * 2 PI) + (1 PI / 6)));
